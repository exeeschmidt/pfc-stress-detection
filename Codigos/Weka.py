...
class MetodosWeka:
    def __init__(self, metodo_clasificacion, metodo_seleccion):
    ...
    def __call__(self, path, bool_seleccion):
        try:
            jvm.start()
            self.__ejecuta__(path, bool_seleccion)
        except Exception as e:
            print(traceback.format_exc())
        finally:
            jvm.stop()

    def __ejecuta__(self, path, bool_seleccion):
        # Cargo los datos
